...
for i in images:
    for s in styles:
        ...
        orig_mask_mask = cv2.imread(path + '/1.training_set/second_img/s_image_'+str(i)+'.jpg')
        not_img = cv2.imread(path + '/1.training_set/not_img/n_image_'+str(i)+'.jpg')
        second_img = cv2.imread(path + '/1.training_set/second_img/s_image_'+str(i)+'.jpg')
